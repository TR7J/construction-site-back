...
router.post("/material/:projectId", authMiddleware_1.AuthMiddleware, supervisorController_1.addOrUpdateMaterial);
// Worker management routes
router.post("/workers", authMiddleware_1.AuthMiddleware, supervisorController_1.addWorker);
// Get all materials
router.get("/materials/:projectId", authMiddleware_1.AuthMiddleware, supervisorController_1.getMaterials);
...
// Post Labour
router.post("/labour/:projectId", authMiddleware_1.AuthMiddleware, supervisorController_1.addLabour);
// Get Labours
router.get("/labours/:projectId", authMiddleware_1.AuthMiddleware, supervisorController_1.getLabours);
// Get Labour by id
